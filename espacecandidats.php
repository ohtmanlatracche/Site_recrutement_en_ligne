...
<header>
    ...
    <div style="width: 60vw;height: 76vh;margin-top: 25vh;margin-bottom: 25vh;background: linear-gradient(90deg, rgba(2,246,255,1) 13%, rgba(56,152,158,1) 46%, rgba(0,212,255,1) 100%);
;margin-left: 18vw;border: 4px double white;border-radius: 15px;" class="tout">
        ...
        <center>
            <div style="margin-top: 30px;box-shadow: 0 0 20px rgba(0,0,0.5);border-radius: 5px;" class="ss">
                <div style="border: 4px double white;border-radius: 35px;width: 25vw;box-shadow: 0 0 10px rgba(0,0,0.5);" class="dd">
